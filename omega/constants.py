...
SPEECH_CONTENT_SCALING_FACTOR = 1.0 - BACKGROUND_NOISE_SCALING_FACTOR - \
    SPEAKER_DOMINANCE_SCALING_FACTOR - UNIQUE_SPEAKERS_ERROR_SCALING_FACTOR
AUDIO_LENGTH_SCALING_FACTOR = 0.1  # max 1
AUDIO_QUALITY_SCALING_FACTOR = 0.2  # max 1
DIARIZATION_SCALING_FACTOR = 0.6  # max 1
AUDIO_QUERY_RELEVANCE_SCALING_FACTOR = 1.0 - DIARIZATION_SCALING_FACTOR - \
    AUDIO_LENGTH_SCALING_FACTOR - AUDIO_QUALITY_SCALING_FACTOR
