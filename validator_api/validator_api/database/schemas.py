...
class KeyPoint(BaseModel):
    ...
    links: Optional[List[Link]] = Field(
        None, description="Relevant links for the key point"
    )
...
class Analysis(BaseModel):
    ...
    links: Optional[List[Link]] = Field(
        None, description="Relevant links for the analysis"
    )
...
class TextAnalysisReport(BaseModel):
    ...
    timestamp: str = Field(
        ...,
        description="Timestamp of the report generation (ISO 8601 date string YYYY-MM-DDTHH:MM:SS-UTC)",
    )
    links: Optional[List[Link]] = Field(
        None, description="General links for the entire report"
    )
